...
use App\Http\Resources\Api\V1\ManageTimesheet\ManageTimesheetLogsExportResource;
...
class ManageTimesheetLogsExports implements FromCollection, WithHeadings, WithStyles, WithCustomStartCell, WithEvents, WithColumnWidths
{
    public function __construct(
        protected $manageTimesheetLogs,
        protected $user,
        protected $data = ([]),
    ) {
    }
    ...
    {
        $this->data =  $this->manageTimesheetLogs->map(
            fn ($manageTimesheetLog): ManageTimesheetLogsExportResource => new ManageTimesheetLogsExportResource(
                $manageTimesheetLog
            )
        );
